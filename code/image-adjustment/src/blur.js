 ...
 */
 export default function localBlur(source, radius, bounding, output) {
    // 获取图像资源
  ...
  */
  class Blur {
    ...
    doGaussian(pixels, width, height, outPixels) {
    ...
    createSourceCanvas(img, sx, sy, sw, sh, radius, ext) {
      var dx = 0,
          dy = 0;
      var width = sw,
          height = sh;
